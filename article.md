...
[load-test.ts](https://github.com/r-sugi/rdb-deadlock-demo/blob/main/load-test.ts) / [sfu-load-test.ts](https://github.com/r-sugi/rdb-deadlock-demo/blob/main/sfu-load-test.ts) を参照。
